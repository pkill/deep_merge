        ...
        if knockout_prefix
          ...
          source.delete_if do |ko_item|
            ...
            if item != ko_item
              ...
              # If dest.delete was successful, knockout source item
              retval = preserve_knockout && dest.delete("#{knockout_prefix}#{ko_item}")
              if retval
                print "#{knockout_prefix}#{ko_item} - " if merge_debug
                dest.delete(ko_item)
              end
            end
            retval
